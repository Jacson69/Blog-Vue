...
<div class="login-wrap">
	<div class="form-structor">
		<div class="signup" :class="{'slide-up': flag}">
			...
			<div class="form-holder" @keyup.enter="()=>{handlerenter(0)}">
		...
		<div class="login" :class="{'slide-up': !flag}">
			<div class="center" >
				...
				<div class="form-holder" @keyup.enter="()=>{handlerenter(1)}">
				...
				<button class="submit-btn" @click="handleLogin" @keyup.enter="()=>{handlerenter(0)}">Log in</button>
			</div>
		</div>
	</div>
</div>
