...
const state = reactive({
  chart: null, // 图表对象
  sourceData: [
    { name: '收益', month: 'Jan.', money: 59 },
    { name: '收益', month: 'Feb.', money: 39 },
    { name: '收益', month: 'Mar.', money: 80 },
    { name: '收益', month: 'Apr.', money: 300 },
    { name: '收益', month: 'May', money: 120 },
    { name: '收益', month: 'Jun.', money: 320 },
    { name: '收益', month: 'Jul.', money: 550 },
    { name: '收益', month: 'Aug.', money: 60 },
    { name: '收益', month: 'Step', money: 84.5 },
    { name: '收益', month: 'Oct.', money: 150 },
    { name: '收益', month: 'Nov.', money: 200 },
    { name: '收益', month: 'Dec.', money: 390 },
    { name: '下载', month: 'Jan.', money: 200 },
    { name: '下载', month: 'Feb.', money: 280 },
    { name: '下载', month: 'Mar.', money: 320 },
